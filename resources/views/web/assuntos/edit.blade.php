...
@section('content')
    ...
    <form action="{{ route('assuntos.update', $assunto->CodAs) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control @error('Descricao') is-invalid @enderror" id="Descricao" name="Descricao" value="{{ old('Descricao', $assunto->Descricao) }}" required maxlength="20">
            @error('Descricao')
